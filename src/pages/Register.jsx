...
function Register() 
{
    ...
    const formik = useFormik({
        ...
        validationSchema : Yup.object({
         ...
         onSubmit : function(value){
            let reobj = {id,name,mob,email,password};
            console.log(reobj);
  ...
  return (
    ...
    <FormGroup >
        ...
        <Input  className={` block w-full rounded border py-1 px-2 ${formik.touched.id && formik.errors.id ? 'border-red-400' : 'border-gray-300'}`}
